...
void RenderObject::constructVAO()
{
    glBindVertexArray(__vao);
        ...
        glUniformMatrix4fv(glGetUniformLocation(shader->getID(), "rotation"), 4, GL_FALSE, &(*rotationMatrix)[0]);
        glUniformMatrix4fv(glGetUniformLocation(shader->getID(), "projection"), 4, GL_FALSE, &(*projectionMatrix)[0]);
